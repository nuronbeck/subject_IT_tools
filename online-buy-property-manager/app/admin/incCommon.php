<?php
	...
	if(!$noPathCheck && !is_dir($save_path)){
		...
		<div class="alert alert-danger">
			Ваш сайт не настроен для правильной поддержки сеансов. Пожалуйста, отредактируйте файл php.ini и измените значение <i>сессия.save_path</i> на правильный путь.
			<br><br>
			Текущее значение session.save_path равно'<?php echo $save_path; ?>'.
			</div>
			</center>
		<?php
		exit;
