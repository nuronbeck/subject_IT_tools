	...
	*/
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'applicants_and_tenants' => array(
					'Caption' => 'Заявители и покупатели',
					'Description' => 'Список претендентов / покупатели и их текущий статус. У каждого покупателя может быть заявка или договор покупки.',
					'tableIcon' => 'resources/table_icons/account_balances.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'applications_leases' => array(
					'Caption' => 'Применения / Покупка',
					'Description' => 'Это форма заявки, заполненная заявителем для подачи заявки на покупку объекта. Приложение может быть изменено на покупку после одобрения.',
				...
				'employment_and_income_history' => array(
					'Caption' => 'История занятости и доходов',
					'Description' => 'Записи о занятости и доходах покупателя.',
				...
				'references' => array(
					...
					'Description' => 'Список литературы для каждого покупателя.',
				...
				'rental_owners' => array(
					'Caption' => 'Покупатели',
					'Description' => 'Перечень домовладельцев / владельцев арендуемой недвижимости, а также всех объектов недвижимости, принадлежащих каждому.',
				...
				'properties' => array(
					'Caption' => 'Свойства',
					'Description' => 'Распечатка всех свойств. Каждое свойство имеет владельца и состоит из одного или нескольких единиц покупки.',
					'tableIcon' => 'resources/table_icons/application_home.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'property_photos' => array(
					'Caption' => 'Фотографии недвижимости',
					'Description' => '',
				...
				'units' => array(
					'Caption' => 'Единицы',
					'Description' => 'Список всех подразделений, их данные и текущий статус.',
					'tableIcon' => 'resources/table_icons/change_password.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'unit_photos' => array(
					'Caption' => 'Фотографии блока',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/camera_link.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				'applicants_and_tenants' => 'Заявители и покупатели',
				'applications_leases' => 'Применения / Покупка',
				'residence_and_rental_history' => 'История проживания и покупки',
				'employment_and_income_history' => 'История занятости и доходов',
				'references' => 'Рекомендации',
				'rental_owners' => 'Покупатели',
				'properties' => 'Свойства',
				'property_photos' => 'Фотографии недвижимости',
				'units' => 'Единицы',
				'unit_photos' => 'Фотографии блока'
			);
			...
			if(!$connected){
				...
				if(!extension_loaded('mysql') && !extension_loaded('mysqli')){
					...
					echo Notification::show(array(
						'message' => 'PHP не настроен для подключения к MySQL на этом компьютере. Посмотри пожалуйста <a href="http://www.php.net/manual/en/ref.mysql.php">эта страница</a> за помощь в настройке MySQL.',
						'class' => 'danger',
